...
- Analyze 3-4 major competitors in AI onboarding tools (Deel, Rippling, BambooHR, Workday)
...
Keep your response under 400 words.""",
    ...
    def run(self):
        ...
        # EXERCISE 2 MODIFICATION: Updated initial message to match new onboarding focus
        # EXERCISE 3: Added CostAnalyst step to initial message
...
1. ResearchAgent: Start by analyzing the competitive landscape (Deel, Rippling, BambooHR)
2. AnalysisAgent: Then identify key market opportunities in the onboarding space
3. BlueprintAgent: Design the product features and user journey
4. CostAnalyst: Estimate development costs and provide cost-benefit ranking
5. ReviewerAgent: Finally, review and provide strategic recommendations

ResearchAgent, please begin with your market analysis of AI-powered onboarding tools."""
